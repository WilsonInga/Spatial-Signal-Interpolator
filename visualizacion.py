...
class SignalVisualizer:
    ...
    def plot_prediction_comparison(
        ...
        neighbors = self.find_nearest_neighbors(
            target_coords, reference_data, n_neighbors=3
        )
        ...
        error = np.abs(predicted_signal[:signal_length] - nearest_signal)
        ...
        ax_cumulative.plot(
            time_indices, cumulative_error, linewidth=1.5, color="purple"
        )
